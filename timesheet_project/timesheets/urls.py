...
entry_detail = TimeEntryViewSet.as_view({"get": "retrieve", "patch": "partial_update", "delete": "destroy"})
...
urlpatterns = [
    ...
    path("timesheets/<int:pk>/submit/", timesheet_submit, name="timesheet-submit"),
    path("timesheets/<int:pk>/pdf/", timesheet_pdf, name="timesheet-pdf"),
    path("timesheets/<int:timesheet_id>/entries/", entry_list_create, name="entry-list-create"),
    path("entries/<int:pk>/", entry_detail, name="entry-detail"),
    path("entries/<int:pk>/signature/", SignatureView.as_view(), name="entry-signature"),
    path("admin/timesheets/", admin_timesheet_list, name="admin-timesheet-list"),
    path("admin/timesheets/<int:pk>/", admin_timesheet_detail, name="admin-timesheet-detail"),
    path("admin/timesheets/<int:pk>/pdf/", admin_timesheet_pdf, name="admin-timesheet-pdf"),
    path("admin/timesheets/<int:pk>/notes/", admin_timesheet_notes, name="admin-timesheet-notes"),
]
