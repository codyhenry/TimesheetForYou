  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        <Text style={styles.heading}>Please review this time entry before signing.</Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={[styles.fieldValue, styles.bold]}>{entry.total_hours} hours</Text>
        </View>

        <View style={styles.divider} />

        <Text style={styles.confirmText}>By signing, you confirm this time entry is accurate.</Text>
      </View>

      <View style={styles.actions}>
        <TouchableOpacity style={styles.continueButton} onPress={() => router.push(`/entries/${id}/signature`)}>
...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: 16, fontWeight: '600', color: '#212529', marginBottom: 16, lineHeight: 24 },
  divider: { height: 1, backgroundColor: '#dee2e6', marginVertical: 12 },
  row: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8 },
  fieldLabel: { fontSize: 15, color: '#6c757d', fontWeight: '600' },
  fieldValue: { fontSize: 15, color: '#212529', flexShrink: 1, textAlign: 'right' },
  bold: { fontWeight: '700' },
  confirmText: { fontSize: 14, color: '#6c757d', fontStyle: 'italic', lineHeight: 20 },
  actions: { padding: 16, gap: 10 },
  continueButton: { backgroundColor: '#2c3e50', borderRadius: 8, padding: 14, alignItems: 'center' },
