        ...
        {editing ? (
          ...
          <>
            ...
            <View style={styles.row}>
              ...
              <Text style={[styles.value, styles.bold]}>{entry.total_hours}h</Text>
            </View>
            {entry.notes ? (
              <View style={styles.row}>
                <Text style={styles.label}>Notes</Text>
        ...
        {editing ? (
          ...
          <>
            {entry.signature_status !== 'signed' && (
              <TouchableOpacity style={styles.signButton} onPress={() => router.push(`/entries/${entry.id}/review`)}>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#fff', margin: 12, borderRadius: 8, padding: 16, gap: 8 },
  row: {
    flexDirection: 'row',
  ...
  signatureRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 6 },
  ...
  previewBox: { backgroundColor: '#d4edda', borderRadius: 6, padding: 10, marginBottom: 8 },
  ...
  signButton: { backgroundColor: '#28a745', borderRadius: 8, padding: 14, alignItems: 'center' },
  editButton: { backgroundColor: '#2c3e50', borderRadius: 8, padding: 14, alignItems: 'center' },
  saveButton: { backgroundColor: '#28a745', borderRadius: 8, padding: 14, alignItems: 'center' },
  cancelButton: { borderWidth: 1, borderColor: '#6c757d', borderRadius: 8, padding: 14, alignItems: 'center' },
  deleteButton: { backgroundColor: '#dc3545', borderRadius: 8, padding: 14, alignItems: 'center' },
